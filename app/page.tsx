...
export default function Home() {
  return (
    <div className={`${mainFont.className}`}>
      {/* Background */}
      <div className="absolute -z-50 h-screen w-full bg-prime-50 bg-opacity-70"></div>
        ...
        <div className="flex h-screen w-full flex-col justify-center">
          ...
          <div className="relative mt-8">
            ...
            <div className=" bg-white bg-opacity-10 px-16 py-8 backdrop-blur-2xl">
              ...
              <p
                className={`mt-4 text-xl italic text-red ${serifFont.className}`}
              >
...
function ProfileIcons() {
  return (
    <div className="flex h-10 items-center rounded-full border border-gray-200 bg-dark  p-1.5">
      <div className="flex items-center rounded-full bg-prime-50">
        <svg
        ...
        <div className="h-7 w-[1px] bg-dark" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 576 512"
          height={iconSize}
...
function OrangeCircle() {
  return (
    <div className="absolute bottom-0 left-0 right-0 top-0 -z-10 m-auto h-80 w-80 rounded-full bg-gradient-to-b from-start to-end blur-lg" />
  );
}
